...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/activecall/active_call'
  spec.metadata['changelog_uri'] = 'https://github.com/activecall/active_call/blob/main/CHANGELOG.md'
